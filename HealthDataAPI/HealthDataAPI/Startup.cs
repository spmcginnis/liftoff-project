...
namespace HealthDataAPI
{
    public class Startup
    {
        ...
        {
            services.Configure<HealthDataDbSettings>(
                Configuration.GetSection(nameof(HealthDataDbSettings))
                );

            services.AddSingleton<IHealthDataDbSettings>(
